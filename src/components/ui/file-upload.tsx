...
export const FileUpload = ({
  ...
  return (
    ...
    <div className="flex justify-end mb-4">
      <button
        onClick={() => {
          const csvContent = "data:text/csv;charset=utf-8," + encodeURIComponent(`timestamp,fire_start_time,location,severity
2024-01-01 00:00:00,2023-12-31 23:07:00,"45.7747,-73.3052",low
